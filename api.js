...
Api.prototype.run = function (files, options) {
	...
	return new AvaFiles(findOptions)
		.findTestFiles()
		.then(function (files) {
...
Api.prototype._setupPrecompiler = function (files) {
	...
	this.precompiler = new CachingPrecompiler(cacheDir, this.options.babelConfig, this.options.powerAssert);
};
...
Api.prototype._run = function (files, options) {
	...
	var basePath = path.relative('.', commonPathPrefix(files)) + path.sep;
